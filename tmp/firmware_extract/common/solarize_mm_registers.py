...
def registers_to_u32(low, high):
    """Combine two U16 to U32 (Little-Endian: low word first)"""
    return (high << 16) | low


def registers_to_s32(low, high):
    """Combine two U16 to S32 (Little-Endian: low word first)"""
    value = (high << 16) | low
    if value >= 0x80000000:
        value -= 0x100000000
    return value
...
def registers_to_u32_be(high, low):
    """Combine two U16 to U32 (Big-Endian: high word first)"""
    return (high << 16) | low


def registers_to_s32_be(high, low):
    """Combine two U16 to S32 (Big-Endian: high word first)"""
    value = (high << 16) | low
    if value >= 0x80000000:
        value -= 0x100000000
    return value
