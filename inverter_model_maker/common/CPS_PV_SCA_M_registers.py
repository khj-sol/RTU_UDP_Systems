...
class RegisterMap:
    ...
    MODBUS_PROTOCOL_VERSION                  = 0x1A18  # U16
    ...
    ERROR_CODE2                              = ERROR_CODE1  # h01_field=alarm2
    ERROR_CODE3                              = ERROR_CODE1  # h01_field=alarm3
...
class ErrorCode1:
    """Error Code Table1 (0x001D) — Bit field"""
    BITS = {
    }
...
H01_FIELD_MAP = {
    ...
    'alarm2              ': ('ERROR_CODE1', 'raw'),  # user
    'alarm3              ': ('ERROR_CODE1', 'raw'),  # user
}
