...
class RegisterMap:
    ...
    INTERNAL_COMMUNICATION_ERROR             = 0x001A  # U16
    SOFTWARE_INCOMPATIBILITY                 = 0x001B  # U16
    FUNCTION_CODE                            = 0x0086  # U16
    ...
    ERROR_CODE1                              = CONTROL_POWER_LOW
    ERROR_CODE3                              = GROUND_CURRENT_300M_A
...
class ErrorCode7:
    """Error Code Table7 (0x101E) — Bit field"""
    BITS = {
    }
