# -*- coding: utf-8 -*-
"""
new Inverter Modbus Register Map
Based on new Modbus Protocol 
Protocol Name: new
...
class ErrorCode5:
    """Error Code Table5 (0x101E) — Bit field"""
    BITS = {
    }
...
class ErrorCode6:
    """Error Code Table6 (0x101F) — Bit field"""
    BITS = {
    }
...
class ErrorCode7:
    """Error Code Table7 (0x1020) — Bit field"""
    BITS = {
    }
...
class NewStatusConverter:
    """new INVERTER_MODE register already contains InverterMode values."""
