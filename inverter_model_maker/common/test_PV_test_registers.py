# -*- coding: utf-8 -*-
"""
test Inverter Modbus Register Map
Based on test Modbus Protocol 
Protocol Name: test
...
class TestStatusConverter:
    """test INVERTER_MODE register already contains InverterMode values."""
...
DATA_PARSER = {
    'mode                ': 'INVERTER_MODE',
    'r_voltage           ': 'DEA_L1_VOLTAGE (0x03EE~0x03EF); INTERNAL_STORAGE_ERROR (0x000C); L1_VOLTAGE (0x0026)',
