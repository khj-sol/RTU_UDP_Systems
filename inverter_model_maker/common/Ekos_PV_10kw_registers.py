...
class RegisterMap:
    ...
    ERROR_CODE1                              = 계통지락
    ERROR_CODE2                              = SW_FAULT_STATUS_ALARM_1
    ERROR_CODE3                              = HW_FAULT_STATUS_ALARM_2
...
DATA_PARSER = {
    'mode                ': 'INVERTER_MODE',
    'r_voltage           ': 'DEA_L1_VOLTAGE (0x03EE~0x03EF); 계통정전 (0x0004)',
    's_voltage           ': 'DEA_L2_VOLTAGE (0x03F0~0x03F1); L2_VOLTAGE (0x000D); 계통지락 (0x0005)',
    ...
    'frequency           ': 'DEA_FREQUENCY (0x03FA~0x03FB); 과전류_TRIP (0x0002); MC_이상 (0x0008); FREQUENCY (0x000F)',
    'ac_power            ': 'DEA_TOTAL_ACTIVE_POWER (0x03F4~0x03F5)',
    'cumulative_energy   ': 'CUMULATIVE_ENERGY (0x7569); CUMULATIVE_ENERGY_LOW (0x7591)',
    'alarm1              ': 'SW_FAULT_STATUS_ALARM_1 (0x754C)',
    'mppt1_voltage'        : '인버터_DC전압_PV_VOLTAGE',
