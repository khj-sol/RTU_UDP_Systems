# -*- coding: utf-8 -*-
"""
Ekos-PV Inverter Modbus Register Map
Based on Ekos-PV Modbus Protocol 
Protocol Name: ekos-pv
...
class ErrorCode2:
    """Error Code Table2 (0x754C) — Bit field"""
    BITS = {
        0:  "Grid over voltage",
...
class ErrorCode3:
    """Error Code Table3 (0x754D) — Bit field"""
    BITS = {
        0:  "Reserved",
...
class ErrorCode4:
    """Error Code Table4 (0x7597) — Bit field"""
    BITS = {
    }
...
class Ekos-PvStatusConverter:
    """Ekos-PV INVERTER_MODE register already contains InverterMode values."""
...
StatusConverter = Ekos-PvStatusConverter
