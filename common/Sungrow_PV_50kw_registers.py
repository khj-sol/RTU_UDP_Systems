...
class RegisterMap:
    ...
    ERROR_CODE1                              = FAULT_ALARM_CODE_1
...
# Sungrow: 모니터링 레지스터가 0x0000–0x0058, 0x13A0–0x13B8, 0x13BE–0x13D0 등 여러 구간
READ_BLOCKS = [
    {'start': 0x0002, 'count':  80, 'fc': 3},  # Alarm/Status 저주소 블록
    {'start': 0x138C, 'count':  60, 'fc': 3},  # 주 모니터링 블록 (에너지/전력/전압)
]
