...
class RegisterMap:
    ...
    ERROR_CODE1                              = DC_SIDE_SPD_ALARM
    ERROR_CODE2                              = PV1_ABNORMAL
    ERROR_CODE3                              = ELECTRIC_ARC_FAULT
...
DATA_PARSER = {
    'mode                ': 'INVERTER_MODE',
    'r_voltage           ': 'EXCESSIVE_LEAKAGE_CURRENT',
    's_voltage           ': 'COMMUNICATE_FAULT',
    't_voltage           ': 'REG_10_MINUTE_GRID_OVERVOLTAGE',
