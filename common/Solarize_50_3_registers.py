...
class RegisterMap:
    ...
    MPPT4_VOLTAGE                            = 0x103E  # U16, scale V 0.1 (separate block)
    ...
    # 2 trackers x 1 strings x 64 data points
    # =========================================================================
...
def get_string_registers(string_num):
    ...
    Solarize/Senergy: strings are contiguous at 0x1050, 2 regs each (V, I)."""
...
def get_mppt_registers(mppt_num):
    ...
    Solarize/Senergy: MPPT1~3 at 0x1010 stride 4, MPPT4 at 0x103E (separate)."""
...
def get_iv_string_current_registers(mppt_num, string_num, data_points=64):
    """Return {'base', 'count', 'end'} for IV current block of a string (string_num 1-2 per MPPT)."""
    if mppt_num < 1 or mppt_num > 4:
        raise ValueError(f"MPPT number must be 1-4, got {mppt_num}")
