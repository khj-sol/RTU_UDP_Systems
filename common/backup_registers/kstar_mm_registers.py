...
Based on KSTAR Inverter Modbus Communication Protocol
...
class KstarStatusConverter:
    ...
    Maps manufacturer-specific running state codes to standard
    Solarize InverterMode values used by the RTU H01 packet.
    """
...
# RegisterMap alias (modbus_handler dynamic loading)
RegisterMap = KstarRegisters
...
def calc_pv_total_power(block1_data):
    ...
    p1 = block1_data[KstarRegisters.PV1_POWER - base]
    p2 = block1_data[KstarRegisters.PV2_POWER - base]
    p3 = block1_data[KstarRegisters.PV3_POWER - base]
    return p1 + p2 + p3
...
def calc_ac_total_power(block3_data):
    ...
    """
    base = KstarRegisters.BLOCK3_START
    r_raw = block3_data[KstarRegisters.INV_R_POWER - base]
    s_raw = block3_data[KstarRegisters.INV_S_POWER - base]
    t_raw = block3_data[KstarRegisters.INV_T_POWER - base]
...
def get_mppt_registers(mppt_num):
    ...
    v_regs = [KstarRegisters.PV1_VOLTAGE, KstarRegisters.PV2_VOLTAGE, KstarRegisters.PV3_VOLTAGE]
    c_regs = [KstarRegisters.PV1_CURRENT, KstarRegisters.PV2_CURRENT, KstarRegisters.PV3_CURRENT]
...
def get_mppt_data(block1_data, mppt_num):
    ...
    base = KstarRegisters.BLOCK1_START
    voltage_regs = [
        KstarRegisters.PV1_VOLTAGE,
        KstarRegisters.PV2_VOLTAGE,
        KstarRegisters.PV3_VOLTAGE,
    ]
    current_regs = [
        KstarRegisters.PV1_CURRENT,
        KstarRegisters.PV2_CURRENT,
        KstarRegisters.PV3_CURRENT,
    ]
    power_regs = [
        KstarRegisters.PV1_POWER,
        KstarRegisters.PV2_POWER,
        KstarRegisters.PV3_POWER,
    ]
...
def get_cumulative_energy_wh(block1_data):
    ...
    """
    base = KstarRegisters.BLOCK1_START
    low  = block1_data[KstarRegisters.CUMULATIVE_PRODUCTION_L - base]
    high = block1_data[KstarRegisters.CUMULATIVE_PRODUCTION_H - base]
