"""
Senergy (Solarize VK50) Inverter Modbus Register Map
Protocol: senergy (Production)
Based on solarize_mm_registers.py reference
Date: 2026-03-29
"""


class RegisterMap:
    """Senergy (Solarize VK50) Modbus Register Map - Solarize Protocol Compliant"""
...
class SenergyStatusConverter:
    """Senergy INVERTER_MODE register already contains InverterMode values."""

    @classmethod
    def to_inverter_mode(cls, raw):
        """Senergy INVERTER_MODE is already InverterMode-compatible."""
        return raw
