...
class RegisterMap:
    ...
    AC_POWER                                 = 유효전력종합_ACTIVE_POWER  # h01_field=ac_power
    POWER_FACTOR                             = 역률종합_PF  # h01_field=power_factor
    TOTAL_ENERGY                             = CUMULATIVE_ENERGY  # h01_field=cumulative_energy
    ERROR_CODE1                              = SW_FAULT_STATUS_ALARM_1  # h01_field=alarm1
    ERROR_CODE2                              = SW_FAULT_STATUS_ALARM_1  # h01_field=alarm2
    ERROR_CODE3                              = SW_FAULT_STATUS_ALARM_1  # h01_field=alarm3
    ...
    STRING1_VOLTAGE                          = 태양전지1_전압_STRING_1_VOLTAGE
...
H01_FIELD_MAP = {
    ...
    'alarm2              ': ('SW_FAULT_STATUS_ALARM_1', 'raw'),  # user
    'alarm3              ': ('SW_FAULT_STATUS_ALARM_1', 'raw'),  # user
}
